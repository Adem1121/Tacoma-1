...
public class TaxiTest {
    ...
    public void setUp() throws Exception {
        ...
        flightPlanFile = "/Users/fross/Development/Flight Tracking Data Integration System/05 Java/Tacoma/Iteration 11/IO/Taxi KEWR KTPA FlightPlan 20151024 2000.xml";
        eventCollectionFile = "/Users/fross/Development/Flight Tracking Data Integration System/05 Java/Tacoma/Iteration 11/IO/Taxi KEWR KTPA EventCollection 20151024 2000.xml";


        // 01 Load taxi plan and transform to lateral plan
        grndPlan.load(flightPlanFile, 2);
        grndPlan.transform();
        grndPlan.validate();
        ...
        wxPlan.load(eventCollectionFile, 2);
        wxPlan.transform();
        wxPlan.validate();
    ...
    @Test
    public void testGroundTrackProcessing737NGX() throws Exception{
        ...
        String fileName = "F11 Taxi Test " + dateFormat.format(date) + ".txt";
        ...
        for(double trackDist = 0; trackDist < trackLn; timeStmp += cycleLn){
            ...
            bw.write("\t" +
                    ...
                    String.format(Locale.US, "%10.3f", PerfCalc.convertFt(arcrftAxis.getAltAtWpt(pos), "m")) + "\t" +
                    String.format(Locale.US, "%10.3f", 0.0) + "\t" +
                    String.format(Locale.US, "%10.3f", 0.0) + "\t" +
                    String.format(Locale.US, "%10.3f", arcrftAxis.getHeadingAtWpt(pos)) + "\t" +
                    //String.format(Locale.US, "%10.0f", 1.0) + "\t" +
